...
<style>
    ...
    .row-cont { 
        ...
        margin-bottom: -50px; /* 상하 공백 제거 및 겹침 */
        position: relative;
    }

    /* 네모 행(짝수행)을 반 칸(65px) 옆으로 밀어 중앙 정렬 */
...
for r in range(5):
    ...
    for _, row in sub_df.iterrows():
        ...
        # HTML 내부 줄바꿈 시 에러가 나지 않도록 한 줄로 작성하거나 따옴표를 정확히 처리
